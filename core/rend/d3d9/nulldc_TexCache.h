...
public:
	...
	TexEntryType* DYNACALL Find(u32 tcw,u32 tsp)
	{
...
u32 DYNACALL twiddle_fast(u32 x,u32 y,u32 x_sz,u32 y_sz);
...
{ \
	...
	__forceinline static void DYNACALL Convert(PixelBuffer* pb,u8* data) \
{
...
void DYNACALL texture_PL(PixelBuffer* pb,u8* p_in,u32 Width,u32 Height)
{
	u32 p=0;
	pb->amove(0,0);
...
void DYNACALL texture_PL_RAW(PixelBuffer* pb,u8* p_in,u32 Width,u32 Height)
{
	u32 sz=Width*2;
	Height>>=1;	//half
...
template<class PixelConvertor>
void DYNACALL texture_TW(PixelBuffer* pb,u8* p_in,u32 Width,u32 Height)
{
	u32 p=0;
	pb->amove(0,0);
...
template<class PixelConvertor>
void DYNACALL texture_VQ(PixelBuffer* pb,u8* p_in,u32 Width,u32 Height)
{
	p_in+=256*4*2;
	u32 p=0;
	pb->amove(0,0);
...
//;)
//planar formats !
template void DYNACALL texture_PL<conv4444_PL<pp_dx> >(PixelBuffer* pb,u8* p_in,u32 Width,u32 Height);
template void DYNACALL texture_PL<conv565_PL<pp_dx> >(PixelBuffer* pb,u8* p_in,u32 Width,u32 Height);
template void DYNACALL texture_PL<conv1555_PL<pp_dx> >(PixelBuffer* pb,u8* p_in,u32 Width,u32 Height);
template void DYNACALL texture_PL<convYUV_PL<pp_dx> >(PixelBuffer* pb,u8* p_in,u32 Width,u32 Height);

//twiddled formats !
template void DYNACALL texture_TW<conv4444_TW<pp_dx> >(PixelBuffer* pb,u8* p_in,u32 Width,u32 Height);
template void DYNACALL texture_TW<conv565_TW<pp_dx> >(PixelBuffer* pb,u8* p_in,u32 Width,u32 Height);
template void DYNACALL texture_TW<conv1555_TW<pp_dx> >(PixelBuffer* pb,u8* p_in,u32 Width,u32 Height);
template void DYNACALL texture_TW<convYUV_TW<pp_dx> >(PixelBuffer* pb,u8* p_in,u32 Width,u32 Height);
template void DYNACALL texture_TW<convPAL4_TW<pp_dx> >(PixelBuffer* pb,u8* p_in,u32 Width,u32 Height);
template void DYNACALL texture_TW<convPAL8_TW<pp_dx> >(PixelBuffer* pb,u8* p_in,u32 Width,u32 Height);

//VQ formats !
template void DYNACALL texture_VQ<conv4444_TW<pp_dx> >(PixelBuffer* pb,u8* p_in,u32 Width,u32 Height);
template void DYNACALL texture_VQ<conv565_TW<pp_dx> >(PixelBuffer* pb,u8* p_in,u32 Width,u32 Height);
template void DYNACALL texture_VQ<conv1555_TW<pp_dx> >(PixelBuffer* pb,u8* p_in,u32 Width,u32 Height);
template void DYNACALL texture_VQ<convYUV_TW<pp_dx> >(PixelBuffer* pb,u8* p_in,u32 Width,u32 Height);
//template void DYNACALL texture_VQ<convPAL4_TW<pp_dx> >(PixelBuffer* pb,u8* p_in,u32 Width,u32 Height);
//template void DYNACALL texture_VQ<convPAL8_TW<pp_dx> >(PixelBuffer* pb,u8* p_in,u32 Width,u32 Height);
...
/*
void DYNACALL texture_VQ_argb565(PixelBuffer* pb,u8* p_in,u32 Width,u32 Height);
void DYNACALL texture_VQ_argb1555(PixelBuffer* pb,u8* p_in,u32 Width,u32 Height);
void DYNACALL texture_VQ_argb4444(PixelBuffer* pb,u8* p_in,u32 Width,u32 Height);
void DYNACALL texture_VQ_YUV422(PixelBuffer* pb,u8* p_in,u32 Width,u32 Height);
void DYNACALL texture_VQ_PAL4(PixelBuffer* pb,u8* p_in,u32 Width,u32 Height);
void DYNACALL texture_VQ_PAL8(PixelBuffer* pb,u8* p_in,u32 Width,u32 Height);
*/

void DYNACALL texture_PAL4(PixelBuffer* pb,u8* p_in,u32 Width,u32 Height);
void DYNACALL texture_PAL8(PixelBuffer* pb,u8* p_in,u32 Width,u32 Height);
